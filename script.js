...
fetch('https://api.unsplash.com/photos/random/?orientation=landscape&query=nature&client_id=T2h31niZhJkBL8ZLiiYTGhBN6UtNIxhGc4FFwiuaxgA')
.then(response => response.json())
.then(data => {
  ...
  const creditString = `Photo by <a href="https://unsplash.com/@anabg1?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Ana Bórquez</a> on <a href="https://unsplash.com/photos/uF4PfwZPOR8?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>`;
